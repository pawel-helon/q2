...
export function DataTableSearch<TData>({ table, pathname }: { table: Table<TData>, pathname: string }) {
  ...
  return (
    <div className="flex justify-between border-b border-border pb-1 my-4 xs:my-12">
      <div className="flex items-center">
        ...
        <Input
          placeholder={pathname === "/notifications" ? "Search by title": "Search by name"}
          spellCheck={false}
          value={
